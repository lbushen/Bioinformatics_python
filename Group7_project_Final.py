...
for value in seq_dict.values():
    ...
    for match1 in m123:
      ...
      #FRAMES 1,2,3  #Nabin
        ...
        if length1>ORF_length:
            ...
            print(seq_name[0]+" | FRAME= "+str(frame1)+" | POS= "+ str(pos)+" | LEN= "+str(length1)),codon15(fw_frame)
    ...
    for match2 in m456:
        ...
        if length2>ORF_length:
            ...
            print(seq_name[0]+" | FRAME= "+str(frame2)+" | POS= "+ str(pos)+" | LEN= "+str(length2)),codon15(rev_frame)
